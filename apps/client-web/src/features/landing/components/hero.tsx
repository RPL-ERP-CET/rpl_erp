...
export default function Hero() {
  ...
  return (
    <section className="w-full h-full px-8 py-16 flex justify-center items-center gap-4 bg-gradient-to-b from-primary to-primary-foreground sm:px-24 xl:px-64">
